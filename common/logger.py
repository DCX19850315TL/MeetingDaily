...
#setting_file = os.path.join(parent_dir,'conf\seeting.ini')
setting_file = os.path.join(os.path.abspath('conf'),'seeting.ini')
...
LogFile = os.path.join(os.path.abspath('logs'),'%s' % str(LogName))
#print LogFile
#日志级别
